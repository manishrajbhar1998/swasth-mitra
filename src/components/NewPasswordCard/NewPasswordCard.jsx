...
import { POST_FORGOT_PASSWORD, POST_RESET_PASSWORD } from '../../constant/config';
...
const NewPasswordCard = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            setLoading(true)
            const response = await api.post(POST_RESET_PASSWORD, reqBody);
            if (response?.data) {
